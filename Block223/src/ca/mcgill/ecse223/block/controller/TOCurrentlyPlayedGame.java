...
public class TOCurrentlyPlayedGame
{
  ...
  public TOCurrentBlock addBlock(int aRed, int aGreen, int aBlue, int aPoints, int aX, int aY, int aBlastRadius)
  {
    return new TOCurrentBlock(aRed, aGreen, aBlue, aPoints, aX, aY, aBlastRadius, this);
  }
