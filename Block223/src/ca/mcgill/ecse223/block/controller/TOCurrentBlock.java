...
public class TOCurrentBlock
{
  ...
  public TOCurrentBlock(int aRed, int aGreen, int aBlue, int aPoints, int aX, int aY, int aBlastRadius, TOCurrentlyPlayedGame aTOCurrentlyPlayedGame)
  {
    red = aRed;
    green = aGreen;
    blue = aBlue;
  ...
  public String toString()
  {
    return super.toString() + "["+
            ...
            "x" + ":" + getX()+ "," +
            "y" + ":" + getY()+ "," +
            "blastRadius" + ":" + getBlastRadius()+ "]" + System.getProperties().getProperty("line.separator") +
